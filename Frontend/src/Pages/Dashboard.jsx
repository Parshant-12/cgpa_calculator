        ...
        <MotionCard className="w-full max-w-[1200px] mx-auto relative z-10" hover={false}>
          <section className="w-full p-6 md:p-10 border border-slate-700/40 rounded-3xl bg-[#091022]/90 shadow-[0_0_40px_rgba(0,0,0,0.5)] backdrop-blur-xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
              <button onClick={addSemester} className="flex cursor-pointer items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-slate-600 bg-slate-800/30 text-sm font-medium hover:bg-slate-800/60 transition-colors"><Plus size={18} /> Add Semester</button>
              <button onClick={calculate} className="flex cursor-pointer items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-btn-gradient shadow-[0_8px_20px_rgba(231,48,177,0.25)] text-sm font-bold text-white hover:brightness-110 transition-all"><Calculator size={18} /> Calculate Your CGPA</button>
            </div>
